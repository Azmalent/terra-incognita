...
public class ModLootModifiers {
    public static final DeferredRegister<GlobalLootModifierSerializer<?>> LOOT_MODIFIERS = REGISTRY_HELPER.getOrCreateRegistry(ForgeRegistries.Keys.LOOT_MODIFIER_SERIALIZERS);
