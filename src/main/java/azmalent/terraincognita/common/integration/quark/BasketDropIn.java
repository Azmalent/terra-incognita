...
public class BasketDropIn extends AbstractDropIn {
    @Override
    public boolean canDropItemIn(PlayerEntity player, ItemStack basket, ItemStack stack) {
    ...
    @Override
    public ItemStack dropItemIn(PlayerEntity player, ItemStack basket, ItemStack stack) {
        BasketStackHandler stackHandler = BasketItem.getStackHandler(basket);
