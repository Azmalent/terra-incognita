...
public class ModVegetationPlacements {
    ...
    public static final RegistryObject<PlacedFeature> ALPINE_FLOWERS = ModPlacedFeatures.register(
    ...
    public static final RegistryObject<PlacedFeature> EDELWEISS = ModPlacedFeatures.register(
    ...
    public static final RegistryObject<PlacedFeature> SAXIFRAGE_PATCH = ModPlacedFeatures.register(
    ...
    public static final RegistryObject<PlacedFeature> ARCTIC_FLOWERS = ModPlacedFeatures.register(
    ...
    public static final RegistryObject<PlacedFeature> FOREST_FLOWERS = ModPlacedFeatures.register(
        "forest_flowers", ModVegetationFeatures.FOREST_FLOWERS, () -> List.of(
            RarityFilter.onAverageOnceEvery(16), InSquarePlacement.spread(), PlacementUtils.HEIGHTMAP, BiomeFilter.biome()
        )
    );

    public static final RegistryObject<PlacedFeature> SAVANNA_FLOWERS = ModPlacedFeatures.register(
        "savanna_flowers", ModVegetationFeatures.SAVANNA_FLOWERS, () -> List.of(
            RarityFilter.onAverageOnceEvery(16), InSquarePlacement.spread(), PlacementUtils.HEIGHTMAP, BiomeFilter.biome()
        )
    );

    public static final RegistryObject<PlacedFeature> SWAMP_FLOWERS = ModPlacedFeatures.register(
    ...
    //Misc vegetation
    public static final RegistryObject<PlacedFeature> CACTUS_FLOWERS = ModPlacedFeatures.register(
        "cactus_flowers", ModVegetationFeatures.CACTUS_FLOWERS, () -> List.of(BiomeFilter.biome())
    );

    public static final RegistryObject<PlacedFeature> CARIBOU_MOSS = ModPlacedFeatures.register(
    ...
    public static final RegistryObject<PlacedFeature> HANGING_MOSS_PATCH = ModPlacedFeatures.register(
    ...
    public static final RegistryObject<PlacedFeature> LOTUS = ModPlacedFeatures.register(
        "lotus", ModVegetationFeatures.LOTUS, () -> VegetationPlacements.worldSurfaceSquaredWithCount(4)
    );

    public static final RegistryObject<PlacedFeature> SWAMP_REEDS = ModPlacedFeatures.register(
    ...
    public static final RegistryObject<PlacedFeature> SWEET_PEAS = ModPlacedFeatures.register(
    ...
    public static final RegistryObject<PlacedFeature> WITHER_ROSES = ModPlacedFeatures.register(
    ...
    //Biome specific
    public static final RegistryObject<PlacedFeature> PLAINS_APPLE_TREES = ModPlacedFeatures.register(
    ...
    public static final RegistryObject<PlacedFeature> FOREST_HAZEL_TREES = ModPlacedFeatures.register(
    ...
    public static final RegistryObject<PlacedFeature> BOREAL_FOREST_TREES = ModPlacedFeatures.register(
    ...
    public static final RegistryObject<PlacedFeature> SPARSE_LARCH_TREES = ModPlacedFeatures.register(
    ...
    public static final RegistryObject<PlacedFeature> RARE_LARCH_TREES = ModPlacedFeatures.register(
    ...
    public static final RegistryObject<PlacedFeature> CLEARING_VEGETATION = ModPlacedFeatures.register(
    ...
    public static final RegistryObject<PlacedFeature> GINKGO_GROVE_FLOWERS = ModPlacedFeatures.register(
    ...
    public static final RegistryObject<PlacedFeature> GINKGO_GROVE_TREES = ModPlacedFeatures.register(
    ...
    public static final RegistryObject<PlacedFeature> SOUR_BERRIES = ModPlacedFeatures.register(
