...
import static azmalent.terraincognita.common.world.configured.ModFlowerFeatures.States.*;
...
public class ModFlowerFeatures {
    public static class States {
        ...
        static final BlockState HEATHER         = ModBlocks.HEATHER.getBlock().defaultBlockState();
    ...
    public static class StateProviders {
        ...
        static final WeightedStateProvider SAVANNA_FLOWERS      = new WeightedStateProvider().add(MARIGOLD, 2).add(GLADIOLUS, 1).add(SNAPDRAGON, 1);
        static final WeightedStateProvider SAVANNA_TALL_FLOWERS = new WeightedStateProvider().add(OLEANDER, 2).add(SAGE, 3);
        static final WeightedStateProvider ARCTIC_FLOWERS       = new WeightedStateProvider().add(HEATHER, 2).add(WHITE_DRYAD, 3);
