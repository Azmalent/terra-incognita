...
public class ModTreeFeatures {
    ...
    public static final Holder<ConfiguredFeature<TreeConfiguration, Feature<TreeConfiguration>>> LARCH_TALL = registerTreeFeature(
        "larch_tall", LarchTree.getTreeConfig(true)
    );

    public static final Holder<? extends ConfiguredFeature<?,?>> MEGA_LARCH = registerTreeFeature(
