...
public class ModTreeFeatures {
    public static class States {
        static final BlockState APPLE_LOG = ModWoodTypes.APPLE.LOG.defaultBlockState();
        static final BlockState APPLE_LEAVES = ModWoodTypes.APPLE.LEAVES.defaultBlockState();
        static final BlockState BLOSSOMING_APPLE_LEAVES = ModWoodTypes.APPLE.BLOSSOMING_LEAVES.defaultBlockState();
        static final BlockState HAZEL_LOG = ModWoodTypes.HAZEL.LOG.defaultBlockState();
        static final BlockState HAZEL_LEAVES = ModWoodTypes.HAZEL.LEAVES.defaultBlockState();
    }
