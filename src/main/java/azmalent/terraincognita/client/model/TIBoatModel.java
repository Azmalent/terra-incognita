...
@OnlyIn(Dist.CLIENT)
public class TIBoatModel extends SegmentedModel<TIBoatEntity> {
     ...
     */
    public void setRotationAngles(TIBoatEntity entityIn, float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch) {
    ...
    protected void func_228244_a_(TIBoatEntity p_228244_1_, int p_228244_2_, float p_228244_3_) {
