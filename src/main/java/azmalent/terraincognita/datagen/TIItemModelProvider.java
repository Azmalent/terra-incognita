...
public class TIItemModelProvider extends ItemModelProvider {
    public TIItemModelProvider(DataGenerator generator, ExistingFileHelper existingFileHelper) {
        super(generator, TerraIncognita.MODID, existingFileHelper);
    }
    ...
    protected void registerModels() {
        ...
        registerItem(ModItems.FIDDLEHEAD);
